...
from .litellm_notdiamond import NotDiamondConfig

warnings.filterwarnings(
    "ignore", message=".*conflict with protected namespace.*"
)
import os
...
callbacks: List[
    Union[Callable, _custom_logger_compatible_callbacks_literal]
] = []
...
AZURE_DEFAULT_API_VERSION = (
    "2024-08-01-preview"  # this is updated to the latest
)
...
upperbound_key_generate_params: Optional[
    LiteLLM_UpperboundKeyGenerateParams
] = None
...
from litellm.cost_calculator import cost_per_token, response_cost_calculator
...
from litellm.files.main import *
from litellm.fine_tuning.main import *
from litellm.integrations import *
from litellm.llms.AI21.chat import AI21ChatConfig
from litellm.llms.AI21.completion import AI21Config
from litellm.llms.aleph_alpha import AlephAlphaConfig
from litellm.llms.anthropic.chat import AnthropicConfig
from litellm.llms.anthropic.completion import AnthropicTextConfig
...
from litellm.llms.clarifai import ClarifaiConfig
from litellm.llms.cloudflare import CloudflareConfig
from litellm.llms.cohere.completion import CohereConfig
from litellm.llms.custom_llm import CustomLLM
from litellm.llms.databricks.chat import (
    DatabricksConfig,
    DatabricksEmbeddingConfig,
)
from litellm.llms.fireworks_ai import FireworksAIConfig
from litellm.llms.gemini import GeminiConfig
from litellm.llms.huggingface_restapi import HuggingfaceConfig
from litellm.llms.maritalk import MaritTalkConfig
from litellm.llms.nlp_cloud import NLPCloudConfig
...
from litellm.llms.OpenAI.o1_reasoning import OpenAIO1Config
...
from litellm.llms.palm import PalmConfig
from litellm.llms.petals import PetalsConfig
from litellm.llms.predibase import PredibaseConfig
from litellm.llms.replicate import ReplicateConfig
from litellm.llms.sagemaker.sagemaker import SagemakerConfig
...
from litellm.llms.watsonx import IBMWatsonXAIConfig
from litellm.proxy.proxy_cli import run_server
from litellm.rerank_api.main import *
from litellm.router import Router
from litellm.scheduler import *
